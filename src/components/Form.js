      ...
      <form onSubmit={this.handleSubmit}>
        <label>
          ...
          <select value={this.state.value} onChange={this.handleChangeNome}>
            ...
            <option value="ALEXANDRE SERFIOTIS">
            ...
            <option value="ANTONIO CARLOS MENDES THAME">
            ...
            <option value="ARNALDO FARIA DE SÁ">
            ...
            <option value="AROLDE DE OLIVEIRA">
              AROLDE DE OLIVEIRA PSC-RJ
            </option>
            <option value="ARTHUR LIRA">ARTHUR LIRA PP-AL</option>
            <option value="ARTHUR OLIVEIRA MAIA">
              ARTHUR OLIVEIRA MAIA PPS-BA
            </option>
            <option value="ARTHUR VIRGÍLIO BISNETO">
            ...
            <option value="BONIFÁCIO DE ANDRADA">
            ...
            <option value="CAPITÃO FÁBIO ABREU">
            ...
            <option value="DAGOBERTO NOGUEIRA">
            ...
            <option value="DANRLEI DE DEUS HINTERHOLZ">
              DANRLEI DE DEUS HINTERHOLZ PSD-RS
            </option>
            <option value="DARCÍSIO PERONDI">DARCÍSIO PERONDI PMDB-RS</option>
            <option value="DAVI ALVES SILVA JÚNIOR">
              DAVI ALVES SILVA JÚNIOR PR-MA
            </option>
            <option value="DAVIDSON MAGALHÃES">
              DAVIDSON MAGALHÃES PCdoB-BA
            </option>
            <option value="DÉCIO LIMA">DÉCIO LIMA PT-SC</option>
            <option value="DELEGADO ÉDER MAURO">
              DELEGADO ÉDER MAURO PSD-PA
            </option>
            <option value="DELEGADO EDSON MOREIRA">
              DELEGADO EDSON MOREIRA PR-MG
            </option>
            <option value="DELEGADO FRANCISCHINI">
            ...
            <option value="DR. SINVAL MALHEIROS">
            ...
            <option value="EDMILSON RODRIGUES">
            ...
            <option value="EVAIR VIEIRA DE MELO">
            ...
            <option value="FÉLIX MENDONÇA JÚNIOR">
              FÉLIX MENDONÇA JÚNIOR PDT-BA
            </option>
            <option value="FERNANDO COELHO FILHO">
            ...
            <option value="FRANCISCO CHAPADINHA">
              FRANCISCO CHAPADINHA PODE-PA
            </option>
            <option value="FRANCISCO FLORIANO">
            ...
            <option value="GILBERTO NASCIMENTO">
            ...
            <option value="HERMES PARCIANELLO">
            ...
            <option value="JARBAS VASCONCELOS">
            ...
            <option value="JOÃO CARLOS BACELAR">
            ...
            <option value="JOÃO FERNANDO COUTINHO">
              JOÃO FERNANDO COUTINHO PSB-PE
            </option>
            <option value="JOÃO GUALBERTO">JOÃO GUALBERTO PSDB-BA</option>
            <option value="JOÃO MARCELO SOUZA">
              JOÃO MARCELO SOUZA PMDB-MA
            </option>
            <option value="JOÃO PAULO KLEINÜBING">
            ...
            <option value="JOAQUIM PASSARINHO">
            ...
            <option value="JORGE TADEU MUDALEN">
            ...
            <option value="JOSÉ CARLOS ALELUIA">
            ...
            <option value="JOSÉ OTÁVIO GERMANO">
            ...
            <option value="LUIZ CARLOS BUSATO">
            ...
            <option value="LUIZ FERNANDO FARIA">
            ...
            <option value="MARCELO ÁLVARO ANTÔNIO">
            ...
            <option value="MARCO ANTÔNIO CABRAL">
            ...
            <option value="MISSIONÁRIO JOSÉ OLIMPIO">
            ...
            <option value="NELSON MARQUEZELLI">
            ...
            <option value="NIVALDO ALBUQUERQUE">
            ...
            <option value="PASTOR LUCIANO BRAGA">
            ...
            <option value="PAULO HENRIQUE LUSTOSA">
            ...
            <option value="PAULO PEREIRA DA SILVA">
            ...
            <option value="PR. MARCO FELICIANO">
              PR. MARCO FELICIANO PSC-SP
            </option>
            <option value="PROFESSOR SÉRGIO DE OLIVEIRA">
              PROFESSOR SÉRGIO DE OLIVEIRA PSD-PR
            </option>
            <option value="PROFESSOR VICTÓRIO GALLI">
              PROFESSOR VICTÓRIO GALLI PSC-MT
            </option>
            <option value="PROFESSORA DORINHA SEABRA REZENDE">
              PROFESSORA DORINHA SEABRA REZENDE DEM-TO
            </option>
            <option value="PROFESSORA MARCIVANIA">
            ...
            <option value="RAIMUNDO GOMES DE MATOS">
            ...
            <option value="REINHOLD STEPHANES">
            ...
            <option value="ROGÉRIO PENINHA MENDONÇA">
            ...
            <option value="ROSINHA DA ADEFAL">
            ...
            <option value="RUBENS PEREIRA JÚNIOR">
              RUBENS PEREIRA JÚNIOR PCdoB-MA
            </option>
            <option value="SABINO CASTELO BRANCO">
            ...
            <option value="SÓSTENES CAVALCANTE">
              SÓSTENES CAVALCANTE DEM-RJ
            </option>
            <option value="STEFANO AGUIAR">STEFANO AGUIAR PSD-MG</option>
            <option value="SUBTENENTE GONZAGA">
            ...
            <option value="TONINHO WANDSCHEER">
            ...
            <option value="VENEZIANO VITAL DO RÊGO">
